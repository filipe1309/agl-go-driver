...
func (c *userServiceClient) Read(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
...
func (UnimplementedUserServiceServer) Read(context.Context, *UserRequest) (*UserResponse, error) {
...
func _UserService_Read_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Read(ctx, req.(*UserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
